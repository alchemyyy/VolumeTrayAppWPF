...
public static class SettingsBindings
{
    ...
    private static readonly Dictionary<string, EnumComboBinding> EnumComboBindings = new()
    {
        ...
        ["SoundSettingsTarget"] = Bind<SoundSettingsTarget>((s, v) => s.SoundSettingsTarget = v),
        ...
        ["AppDrawerIconsCenterMode"] = Bind<AppDrawerIconsCenterMode>((s, v) => s.AppDrawerIconsCenterMode = v),
        ...
        ["TrayMenuRecordingDeviceNameStyle"] = Bind<TrayMenuDeviceNameStyle>(
            (s, v) => s.TrayMenuRecordingDeviceNameStyle = v),
    };
